...
void main() {
  ...
  group('Auto Job Apply - Complete UI Automation Tests', () {
    testWidgets('Login Screen - UI and Functionality Test', (tester) async {
      ...
      await ScreenshotHelper.takeScreenshot(tester, 'login_screen', suffix: 'initial');
      ...
      await ScreenshotHelper.takeScreenshot(tester, 'login_screen', suffix: 'filled_form');
      ...
      await ScreenshotHelper.takeScreenshot(tester, 'login_screen', suffix: 'after_submit');
    });
    ...
    testWidgets('Dashboard Screen - Navigation and UI Test', (tester) async {
      ...
      await ScreenshotHelper.waitForScreenToLoad(tester);
      await ScreenshotHelper.takeScreenshot(tester, 'dashboard', suffix: 'main_view');
      ...
      if (drawerButton.evaluate().isNotEmpty) {
        ...
        await tester.pumpAndSettle();
        await ScreenshotHelper.takeScreenshot(tester, 'dashboard', suffix: 'drawer_open');
      }
    });
    
    testWidgets('Job Application Screen - Form and Functionality', (tester) async {
      app.main();
      await tester.pumpAndSettle();
      ...
      await ScreenshotHelper.waitForScreenToLoad(tester);
      await ScreenshotHelper.takeScreenshot(tester, 'job_application', suffix: 'form_view');
      ...
      await ScreenshotHelper.takeScreenshot(tester, 'job_application', suffix: 'filled_form');
    });
    ...
    testWidgets('Resume Upload Screen - File Handling Test', (tester) async {
      ...
      await ScreenshotHelper.waitForScreenToLoad(tester);
      await ScreenshotHelper.takeScreenshot(tester, 'resume_upload', suffix: 'initial_view');
      ...
      if (uploadButton.evaluate().isNotEmpty) {
        ...
        await tester.pumpAndSettle();
        await ScreenshotHelper.takeScreenshot(tester, 'resume_upload', suffix: 'upload_dialog');
      }
    });
    ...
    testWidgets('Settings Screen - Configuration Test', (tester) async {
      ...
      await ScreenshotHelper.waitForScreenToLoad(tester);
      await ScreenshotHelper.takeScreenshot(tester, 'settings', suffix: 'main_view');
      ...
      if (themeToggle.evaluate().isNotEmpty) {
        ...
        await tester.pumpAndSettle();
        await ScreenshotHelper.takeScreenshot(tester, 'settings', suffix: 'dark_theme');
      }
    });
    
    testWidgets('Responsive Design Test - Different Screen Sizes', (tester) async {
      app.main();
      await tester.pumpAndSettle();
      ...
      await tester.pumpAndSettle();
      await ScreenshotHelper.takeScreenshot(tester, 'responsive', suffix: 'mobile_375');
      
      // Test tablet size
      await tester.binding.setSurfaceSize(const Size(768, 1024)); // iPad
      await tester.pumpAndSettle();
      await ScreenshotHelper.takeScreenshot(tester, 'responsive', suffix: 'tablet_768');
      
      // Test desktop size
      await tester.binding.setSurfaceSize(const Size(1920, 1080)); // Desktop
      await tester.pumpAndSettle();
      await ScreenshotHelper.takeScreenshot(tester, 'responsive', suffix: 'desktop_1920');
      
      // Reset to default size
      await tester.binding.setSurfaceSize(null);
    });
    
    testWidgets('Accessibility Test - Screen Reader and Navigation', (tester) async {
      app.main();
      await tester.pumpAndSettle();
      ...
      await ScreenshotHelper.takeScreenshot(tester, 'accessibility', suffix: 'keyboard_focus');
    });
  });
}
